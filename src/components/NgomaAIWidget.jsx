...
const styles = {
  floatingButton: { position: "fixed", right: "clamp(14px,2.4vw,28px)", bottom: "clamp(14px,2.4vw,28px)", zIndex: 9999, minWidth: 54, height: 54, padding: "0 17px 0 8px", borderRadius: 999, border: "1px solid rgba(184,134,11,.45)", background: "#11130f", color: "#fff", cursor: "pointer", boxShadow: "0 12px 32px rgba(0,0,0,.22)", display: "flex", alignItems: "center", justifyContent: "center", gap: 9, fontFamily: "'IBM Plex Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif" },
  spark: { width: 38, height: 38, borderRadius: "50%", display: "grid", placeItems: "center", background: "#B8860B", fontFamily: "'IBM Plex Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif", fontWeight: 900, fontSize: 19 },
  floatingLabel: { fontSize: 10, fontWeight: 900, letterSpacing: 1.2, whiteSpace: "nowrap" },
  panel: { position: "fixed", right: "clamp(8px,1.5vw,20px)", bottom: "clamp(76px,8vw,92px)", width: "min(780px,calc(100vw - 16px))", height: "min(760px,calc(100vh - 92px))", background: "#fff", color: "#171914", borderRadius: 18, boxShadow: "0 24px 70px rgba(0,0,0,.28)", display: "flex", overflow: "hidden", zIndex: 10000, border: "1px solid #E7E3D8", fontFamily: "'IBM Plex Sans',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif" },
