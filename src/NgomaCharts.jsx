...
const CERTIFICATION_LEVELS = [
  ...
  { level: "platinum", label: "Platinum", icon: "🎵", iconFilter: "brightness(1.5) saturate(0.15) contrast(1.1) drop-shadow(0 0 3px rgba(200,210,220,0.85))", pts: certificationThresholds.platinum || 400, color: SILVER },
