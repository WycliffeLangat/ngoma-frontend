...
const GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    related: ["lead artist", "country", "featuring artists"],
    keywords: ["main artist", "primary", "lead"],
  },
  {
    id: "featured-artists",
    title: "Featuring artists",
    summary: "The ordered featuring credits for a release.",
    meaning: "Featuring artists display after the primary artists and should link to artist profiles when possible.",
    related: ["unlinked featuring names", "artist profile"],
    keywords: ["featuring", "ft", "feat"],
  },
  {
    id: "unlinked-featured",
    title: "Unlinked featuring names",
    summary: "Text-only featuring credits used when an artist profile does not exist yet.",
...
const WORKFLOWS = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Use Hidden from app only when a point-qualified certification should be held back.",
...
const FAQS = [
  ...
  },
  {
    ...
    title: "What if a featuring artist does not have a profile yet?",
    summary: "Use Unlinked featuring names temporarily, then create or link the artist later.",
    ...
    keywords: ["featuring", "unlinked", "artist"],
  },
  {
    id: "image-size",
